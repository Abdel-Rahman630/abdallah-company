...
export default function AboutUsPage() {
  const countdownData = [
    ...
    { to: 31, suffix: "+", title: "DISTRIBUTOR" },
  ...
  return (
    <>
      <PageBanner image="/about-banner.png" title="About us" />
        ...
        <div className="container mx-auto">
          <RevealText>
            ...
            <h2 className="text-[#1E1E1E] text-[2.5rem] font-bold mb-[40px]">
              About Abdullah Hashim Company Limited
            </h2>
          </RevealText>
            ...
            <div className="w-full flex-1 flex flex-col gap-[24px]">
              ...
              <RevealText delay={0.2}>
                <p className="text-[#666] text-[1rem] font-normal leading-relaxed">
                  ...
                  established in 1940, is a respected business entity in the
                  Kingdom of Saudi Arabia, operating through two primary
                  divisions: Automotive and Euipment. The Auto & Equip Division
                  is committed to delivering premium industrial solutions by
                  representing globally recognized brands. Our focus on service
                  excellence and technical integrity ensures our customers
                  receive superior products, expert support, and an exceptional
                  overall experience.
                </p>
              </RevealText>
              ...
              <RevealText delay={0.3}>
                <p className="text-[#666] text-[1rem] font-normal leading-relaxed">
                  ...
                  - Auto & Equip Division is a leading provider of advanced
                  industrial equipment and solutions across Saudi Arabia. With a
                  diversified portfolio serving sectors such as construction,
                  mining, energy, and logistics, Equipment Division partners
                  with globally established manufacturers—including Yanmar,
                  Yale, Bendi, Xylem, DP-Pumps, LUBI, Kirloskar, ELGi, and many
                  others to offer reliable, high-performance machinery tailored
              ...
              <RevealText delay={0.4}>
                <p className="text-[#666] text-[1rem] font-normal leading-relaxed">
                  We are dedicated to delivering value through quality products,
                  dependable after-sales service, and deep technical expertise.
                  Our integrated approach ensures that clients benefit from
                  end-to-end support, including installation, training, and
              ...
              <RevealText delay={0.5}>
                <p className="text-[#666] text-[1rem] font-normal leading-relaxed">
                  ...
                  Auto & Equip Division plays a vital role in supporting the
                  Kingdom’s industrial transformation and infrastructure
                  development. By fostering innovation, embracing sustainable
                  practices, and investing in human capital, Auto & Equip
                  Division aligns with national goals to diversify the economy
                  and enhance the role of the private sector in driving
                  long-term growth.
                </p>
              </RevealText>
            </div>
              ...
              <div className="w-full lg:w-1/2 lg:py-[24px] flex flex-col gap-[20px] lg:gap-[60px] justify-center">
                <RevealText delay={0.1}>
                  <div>
                    ...
                    <p className="text-[#666] text-[1rem] font-normal text-justify leading-relaxed">
                      To provide reliable, high quality and innovative products
                      and services in Saudi Arabia, by representing leading
                      brands in the mobility and machinery industry, and to
                      create a distinguished experience for our customers and
                      our team, to benefit all stakeholders.
                    </p>
                  </div>
                </RevealText>
                ...
                <RevealText delay={0.2}>
                  <div>
                    ...
                    <p className="text-[#666] text-[1rem] font-normal text-justify leading-relaxed">
                      We harness our resources for the benefit of people.
                    </p>
                  </div>
                </RevealText>
              </div>
          ...
          <div>
            <RevealText delay={0.1}>
              ...
              <p className="text-[#5E5E5E] text-[1rem] font-normal mb-[3rem]">
                The principles that have guided Abdullah Hashim Company Limited
                for over 80 years of heritage and excellence in the region.
              </p>
            </RevealText>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[24px]">
              {[
                {
                  title: "INTEGRITY",
                  desc: "We conduct business with honesty and transparency in every interaction.",
                  icon: (
                    <svg
                ...
                },
                {
                  ...
                  desc: "Setting the highest standards in quality for our products and the services we provide.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      ...
                      fill="none"
                    >
                      <g clip-path="url(#clip0_876_3765)">
                        <path
                ...
                },
                {
                  ...
                  desc: "Building lasting partnerships based on trust and shared success.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                ...
                },
                {
                  ...
                  desc: "Continuously evolving our solutions to meet the changing needs of the global market.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                ...
                {
                  title: "COLLABORATION",
                  desc: "Fostering an environment of open communication and teamwork across all departments.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                ...
                },
                {
                  ...
                  desc: "Embracing lifelong learning and using data to drive constant improvement.",
                  icon: (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
