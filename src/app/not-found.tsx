...
export default function NotFound() {
  return (
    <main className="min-h-screen bg-[#1E1E1E] flex flex-col items-center justify-center px-4">
      <div className="text-center">
        <h1 className="text-[#D1A52A] text-[8rem] md:text-[12rem] font-bold leading-none tracking-tighter mb-4">
          404
        </h1>
        <h2 className="text-white text-[2rem] md:text-[3rem] font-bold mb-6">
          Page Not Found
        </h2>
