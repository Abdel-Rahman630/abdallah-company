      ...
      <div className="flex flex-col w-full">
        ...
        {locations.length === 0 ? (
          <div className="flex p-[35px] lg:p-[50px] flex-col rounded-[5px] bg-[#FFF] items-center justify-center border border-[#E5E5E5]">
            <span className="text-[#1E1E1E] text-[1.5rem] font-semibold">There is no locations</span>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-x-[40px] gap-y-[40px]">
            {currentItems.map((loc) => {
              const mapUrl = loc.googleMapsUrl || (loc.mapQuery ? `https://maps.google.com/?q=${encodeURIComponent(loc.mapQuery)}` : '#');
                ...
                <div key={loc.id} className="flex flex-col">
                  ...
                  <div className="flex p-[35px] lg:p-[50px] flex-col rounded-[5px] bg-[#FFF]">
                    <div className="flex items-center gap-[12px] mb-[32px]">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <g clipPath="url(#clip0_1187_8503)">
                          <path d="M12.7324 1.96406C11.4721 0.698337 9.79307 0.00125985 8.00457 0.00125985H7.99685C4.39535 -0.0724538 1.23572 3.09927 1.30987 6.69946C1.40415 9.24163 3.84976 12.4701 5.75426 14.9505C6.31356 15.6186 7.12851 16 8.00401 16C8.9102 16 9.75158 15.5917 10.3124 14.8797C11.7252 13.124 14.776 8.90121 14.6839 6.6994C14.6839 4.90961 13.9908 3.22791 12.7324 1.96406ZM9.33048 14.1063C8.68462 14.9582 7.32599 14.9598 6.67988 14.1078C4.09746 10.8195 2.55973 8.08099 2.55973 6.69943C2.55973 3.69526 4.99881 1.25121 7.99685 1.25121H8.00457C10.9984 1.25121 13.434 3.69529 13.434 6.69943C13.434 8.09602 11.9383 10.7957 9.33048 14.1063ZM8.03198 9.34428C6.56742 9.34428 5.37591 8.15276 5.37591 6.68821C5.5218 3.16457 10.5427 3.16561 10.688 6.68824C10.688 8.1528 9.49653 9.34428 8.03198 9.34428ZM8.03198 5.28205C7.25662 5.28205 6.62582 5.91286 6.62582 6.68821C6.70307 8.55367 9.36117 8.55311 9.43813 6.68821C9.43813 5.91286 8.80736 5.28205 8.03198 5.28205Z" fill="#666666"/>
                        </g>
                        <defs>
                    ...
                    <a href={mapUrl} target="_blank" rel="noreferrer" className="flex items-center gap-[10px]">
                      ...
                      <span className="text-[#231F20] text-[0.9rem] font-bold">Get Directions</span>
                    </a>
                  </div>
                </div>
              );
        ...
        {pageCount > 1 && (
          <nav className="mt-[40px] flex justify-center" aria-label="Locations pagination">
            <ReactPaginate
              pageCount={pageCount}
