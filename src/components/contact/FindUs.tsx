    ...
    <section id="find-us" className="bg-[#1E1E1E] py-[100px]">
      <div className="container mx-auto">
        ...
        <RevealText delay={0.2}>
          <h2 className="text-white text-center text-[3rem] font-bold mb-[40px]">Find Us</h2>
        </RevealText>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-stretch gap-[32px] mb-[40px] pb-[40px] border-b-[4px] border-[rgba(201,168,76,0.8)]">
            <div className="flex-1 border-b border-[#D1A52A] pb-[32px] lg:border-b-0 lg:pb-0 lg:border-r lg:border-[#D1A52A] lg:pr-[32px]">
              <div className="flex items-center gap-[12px] mb-[1rem] flex-wrap">
                <h3 className="text-white text-[1.5rem] font-bold">Head Office</h3>
                <span className="rounded-[4px] bg-[#D1A52A] text-[#1E1E1E] text-[0.7rem] font-bold uppercase px-[8px] py-[4px]">
                  Jeddah
                </span>
              
              </div>
              <p className="text-[rgba(255,255,255,0.80)] text-[1rem] font-normal leading-relaxed mb-[1rem]">
                44, Jeddah 21411, Madinah Road Al Bawadi Dist, Jeddah
              </p>
              <div className="flex gap-[48px] shrink-0">
                <div>
                  <h4 className="text-[#D1A52A] text-[0.8rem] font-semibold uppercase mb-[8px]">Email Address</h4>
                  <a
                    href="mailto:info@ahcl.com.sa"
                    className="text-white text-[1rem] font-normal hover:text-[#D1A52A] transition-colors"
                  >
                    info@ahcl.com.sa
                  </a>
                </div>
                <div>
                  <h4 className="text-[#D1A52A] text-[0.8rem] font-semibold uppercase mb-[8px]">Phone Number</h4>
                  <a
                    href="tel:0122638200"
                    className="text-white text-[1rem] font-normal hover:text-[#D1A52A] transition-colors"
                  >
            ...
            <div className="flex-1 border-b border-[#D1A52A] pb-[32px] lg:border-b-0 lg:pb-0 lg:border-r lg:border-[#D1A52A] lg:pr-[32px]">
              <div className="flex items-center gap-[12px] mb-[1rem] flex-wrap">
                <h3 className="text-white text-[1.5rem] font-bold">Central Region Office</h3>
                <span className="rounded-[4px] bg-[#D1A52A] text-[#1E1E1E] text-[0.7rem] font-bold uppercase px-[8px] py-[4px]">
                  Riyadh
                </span>
            ...
            <div className="flex-1">
              <div className="flex items-center gap-[12px] mb-[1rem] flex-wrap">
                <h3 className="text-white text-[1.5rem] font-bold">Eastern Region Office</h3>
                <span className="rounded-[4px] bg-[#D1A52A] text-[#1E1E1E] text-[0.7rem] font-bold uppercase px-[8px] py-[4px]">
                  Dammam
                </span>
        ...
        <RevealText delay={0.35}>
          <div className="flex flex-wrap md:flex-nowrap gap-[24px] mb-[24px] justify-center items-center">
            <div className="relative w-[calc(50%-12px)] md:w-1/3">
              <label htmlFor="division-select" className="sr-only">Division</label>
              <select
                id="division-select"
                value={selectedDivision}
                onChange={(e) => setSelectedDivision(e.target.value)}
                className="w-full appearance-none rounded-[4px] border border-[#717171] bg-[#1E1E1E] p-[16px] pr-[40px] text-white outline-none focus:border-[#D1A52A] transition-colors"
              >
              ...
              <div className="absolute right-[16px] top-1/2 -translate-y-1/2 pointer-events-none">
                <svg xmlns="http://www.w3.org/2000/svg" width="9" height="5" viewBox="0 0 9 5" fill="none">
                  <path d="M4.33203 4.5L8.66216 0H0.00190401L4.33203 4.5Z" fill="white" />
                </svg>
              </div>
            </div>
        ...
        {locations.length === 0 && !isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center p-[60px] border border-[rgba(255,255,255,0.1)] rounded-[16px] bg-[rgba(255,255,255,0.02)]">
              ...
              <h3 className="text-white text-[1.5rem] font-bold mb-[8px]">No Locations Found</h3>
                ...
                <div className="w-full h-full min-h-[400px] lg:min-h-[500px] rounded-[16px] overflow-hidden bg-[rgba(255,255,255,0.05)] relative group">
                  {isLoading || !activeLocation ? (
                    <div className="w-full h-full min-h-[400px] lg:min-h-[500px] flex items-center justify-center">
                      <span className="text-[rgba(255,255,255,0.4)]">Loading map...</span>
                    </div>
                  ) : (
                    <>
                      <iframe
                      ...
                      {activeLocation.googleMapsUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="absolute bottom-[24px] right-[24px] bg-[#1E1E1E] hover:bg-[#D1A52A] text-white hover:text-black transition-colors px-[16px] py-[10px] rounded-[8px] shadow-lg flex items-center gap-[8px] text-[0.9rem] font-bold z-10 border border-[rgba(255,255,255,0.1)]"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
