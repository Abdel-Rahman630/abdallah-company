...
export default function ProductsDropdown({ isMobile }: { isMobile?: boolean }) {
        ...
        <div className="flex overflow-x-auto gap-5 pb-4 scrollbar-hide">
          {productsData.map((product, index) => (
            <button
              ...
              className={`whitespace-nowrap text-[0.9rem] font-medium transition-colors ${
        ...
        <div className="flex flex-col gap-2 relative">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-[#999] text-[0.85rem] leading-relaxed text-justify">
                {activeProduct.text}
              </p>
              <div className="flex flex-wrap gap-[8px] mt-1 w-max">
  ...
  return (
    <div
      className="bg-[#1E1E1E] rounded-[5px] shadow-[0_0_40px_10px_rgba(0,0,0,0.19)] p-[38px] flex"
