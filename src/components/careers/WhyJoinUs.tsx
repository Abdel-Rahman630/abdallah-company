  ...
  const benefits = [
    {
      ...
      title: t("careers.benefits.growthTitle"),
      desc: t("careers.benefits.growthDesc")
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      title: t("careers.benefits.benefitsTitle"),
      desc: t("careers.benefits.benefitsDesc")
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      title: t("careers.benefits.cultureTitle"),
      desc: t("careers.benefits.cultureDesc")
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
      ...
      title: t("careers.benefits.learningTitle"),
      desc: t("careers.benefits.learningDesc")
    }
  ];
        ...
        <div className="container mx-auto">
          ...
          <div className="mb-[50px]">
            <RevealText delay={0.1}>
              <SubTitle className="!mb-[12px]">{t("careers.whyJoinSubtitle")}</SubTitle>
            </RevealText>
